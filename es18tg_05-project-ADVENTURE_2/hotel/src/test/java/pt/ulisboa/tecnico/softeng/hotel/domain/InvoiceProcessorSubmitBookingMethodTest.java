...
public class InvoiceProcessorSubmitBookingMethodTest {
	...
	private static final String HOTEL_IBAN = "IBAN2";
	...
	@Before
	public void setUp() {
		this.hotel = new Hotel("XPTO234", "Lisboa", HOTEL_NIF, HOTEL_IBAN);

		this.room = new Room(hotel,"01" , Room.Type.SINGLE, AMOUNT);
		this.booking = new Booking(hotel,room, BEGIN, END, NIF, IBAN);
	}
	...
	public void oneTaxFailureOnSubmitInvoice(@Mocked final TaxInterface taxInterface,
		...
		this.hotel.getProcessor().submitBooking(this.booking);
		this.hotel.getProcessor().submitBooking(new Booking(this.hotel, this.room, BEGIN, END, NIF, IBAN));
